...
public static partial class ConnectionExtensions {
	...
	public static int Execute(this IDbConnection connection, string command, ParameterCollection? parameters = null, CommandOptions? options = null) {
	...
	public static IDataReader ExecuteReader(this IDbConnection connection, string command, ParameterCollection? parameters = null, CommandOptions? options = null) {
		if (connection.State == ConnectionState.Closed) connection.Open();
		using var dbCommand = CreateCommand(connection, command, parameters, options);
	...
	public static T QuerySingle<T>(this IDbConnection connection, string command, ParameterCollection? parameters = null, CommandOptions? options = null) where T: class, new() {
		T? record = default;
		var rowCount = 0;
	...
	public static T? QuerySingleOrDefault<T>(this IDbConnection connection, string command, ParameterCollection? parameters = null, CommandOptions? options = null) where T: class, new() {
		T? record = default;
		var rowCount = 0;
