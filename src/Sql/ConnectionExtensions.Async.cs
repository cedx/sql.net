...
public static partial class ConnectionExtensions {
	...
	public static async Task<int> ExecuteAsync(this DbConnection connection, string command, IDictionary<string, object?>? parameters = null, QueryOptions? options = null, CancellationToken cancellationToken = default) {
	...
	public static async Task<IDataReader> ExecuteReaderAsync(this DbConnection connection, string command, IDictionary<string, object?>? parameters = null, QueryOptions? options = null, CancellationToken cancellationToken = default) {
		if (connection.State == ConnectionState.Closed) await connection.OpenAsync(cancellationToken);
		using var dbCommand = (DbCommand) CreateCommand(connection, command, parameters, options);
	...
	public static async Task<object?> ExecuteScalarAsync(this DbConnection connection, string command, IDictionary<string, object?>? parameters = null, QueryOptions? options = null, CancellationToken cancellationToken = default) {
		if (connection.State == ConnectionState.Closed) await connection.OpenAsync(cancellationToken);
		using var dbCommand = (DbCommand) CreateCommand(connection, command, parameters, options);
