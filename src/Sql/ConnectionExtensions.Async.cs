...
public static partial class ConnectionExtensions {
	...
	/// <param name="options">The query options.</param>
	/// <returns>The first column of the first row.</returns>
	public static async Task<T?> ExecuteScalarAsync<T>(this DbConnection connection, string command, IList<object?> parameters, QueryOptions? options = null) where T: IConvertible =>
		(T?) Convert.ChangeType(await ExecuteScalarAsync(connection, command, parameters, options), typeof(T), CultureInfo.InvariantCulture);
